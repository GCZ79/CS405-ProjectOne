// ============================================================
// Batched Noncompliant Code - Paste into Godbolt
// Compiler:  x86-64 clang (latest)
// Flags:     -std=c++17 -Wall -Wextra -Wconversion -Wformat
// Tool:      Clang-Tidy | Args: -checks=cert-*
// ============================================================
